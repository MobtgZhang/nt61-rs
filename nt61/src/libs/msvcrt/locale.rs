//! Thread-safe locale support
//!
//! Replaces unsafe static mut with synchronized access using Mutex and Once
...
pub unsafe extern "C" fn _wsetlocale(category: c_int, locale: *const wchar_t) -> *mut wchar_t {
    static WIDE_LOCALE: Lazy<Mutex<[wchar_t; 32]> = Mutex::new([0; 32]);
