//! loongarch64 backend for the abstract text console.
//!
//! Mirrors the aarch64 / riscv64 backend: serial sink + log
//! ring. The loongarch64 QEMU virt machine uses a 16550A UART
//! that we wired up in `arch::loongarch64::serial`.
...
pub fn clear() {
    ...
    crate::arch::loongarch64::serial::write_string("\x1b[2J\x1b[H\r\n[screen cleared]\r\n");
...
pub fn set_cursor(x: u8, y: u8) {
    ...
    crate::arch::loongarch64::serial::write_string(s);
}
