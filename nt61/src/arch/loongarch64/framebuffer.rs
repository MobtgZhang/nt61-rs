//! Framebuffer driver stub for LoongArch64
//
//! LoongArch64 platforms may use platform-specific display drivers.
...
pub fn init() -> Option<FramebufferInfo> {
    // crate::kprintln!("[TODO] loongarch64: framebuffer driver not yet implemented (arch/loongarch64/framebuffer.rs)")  // kprintln disabled (memcpy crash workaround);
    None
}
